...
export default function ChatInput() {
  ...
  return (
    <div className="w-full p-1 rounded-3xl light-gradient">
      <div className="w-full h-full bg-muted rounded-2xl p-3 md:p-6 grid gap-3">
        <div className="w-full flex items-start gap-2">
          <textarea
            ref={textareaRef}
            value={value}
            onChange={handleChange}
            className="w-full resize-none outline-none border-none muted-scrollbar min-h-10 font-nunito text-foreground"
