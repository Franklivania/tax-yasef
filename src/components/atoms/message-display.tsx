...
export default function MessageDisplay() {
  return (
    <div className="w-full h-full bg-transparent grid gap-3">
      {/* USER INPUT */}
      ...
      <div className="w-full flex items-end gap-2">
        ...
        <Loader />
        <div className="w-full h-max p-3 rounded-3xl bg-background text-foreground border border-border"></div>
      </div>
    </div>
  );
}
